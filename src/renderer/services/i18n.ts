...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imWeixinLoginBtn: '扫码添加微信账号',
    imWeixinLoginHint: '每次扫码可绑定一个新的微信号，支持多账号同时在线',
    imWeixinLoginPending: '等待扫码授权...',
    imWeixinLoginSuccess: '微信账号已登录，AI 机器人将在重启网关后生效',
    imWeixinLoginError: '登录失败，请重试',
    imWeixinGuideStep1: '点击「扫码添加微信账号」按钮',
    imWeixinGuideStep2: '在弹出的终端窗口中，用手机扫描二维码',
    imWeixinGuideStep3: '在手机微信上确认授权，登录凭证将自动保存',
    imWeixinMultiAccount: '多账号说明',
    imWeixinMultiAccountHint: '每次扫码都会新增一个微信账号，所有账号共享同一个 AI 助手上下文。如需账号间独立隔离，可在 OpenClaw 高级设置中开启 per-channel-per-peer 模式。',
  ...
  en: {
    ...
    imWeixinLoginBtn: 'Scan QR Code to Add WeChat Account',
    imWeixinLoginHint: 'Each scan adds a new WeChat account; multiple accounts can be online simultaneously',
    imWeixinLoginPending: 'Waiting for QR code authorization...',
    imWeixinLoginSuccess: 'WeChat account logged in. The AI bot will take effect after restarting the gateway.',
    imWeixinLoginError: 'Login failed, please try again',
    imWeixinGuideStep1: 'Click the "Scan QR Code to Add WeChat Account" button',
    imWeixinGuideStep2: 'Scan the QR code in the terminal window with your WeChat app',
    imWeixinGuideStep3: 'Confirm authorization on your phone; credentials will be saved automatically',
    imWeixinMultiAccount: 'Multi-account',
    imWeixinMultiAccountHint: 'Each scan adds a new WeChat account. All accounts share the same AI context by default. For per-account isolation, enable per-channel-per-peer mode in OpenClaw advanced settings.',
